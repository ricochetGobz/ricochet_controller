...
void ofApp::setup(){
    ...
    thresholdControls.add(farThreshold.set("farThreshold", 180.0, 1.0, 255.0));
    ...
    renderControls.add(minArea.set("minArea", 440.0, 1.0, 3000.0)); // ( sauv : 300.0)
    ...
    cubeDetection.add(sizeCaptured.set("sizeCaptured", 30, 10, 60));
